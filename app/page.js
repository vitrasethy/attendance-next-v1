...
export default function Welcome() {
  return (
    <>
      <div className="relative bg-gradient-to-r from-cyan-500 to-blue-500 sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 selection:bg-red-500 selection:text-white">
        ...
        <p className={"text-5xl font-bold"}>ATTENDANCE</p>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className={"w-24 h-24 mx-4 animate-bounce"}
          viewBox="0 0 448 512">
        ...
        <p className={"text-5xl font-bold"}>SYSTEM</p>
      </div>
    </>
  );
}
